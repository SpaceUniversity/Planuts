...
using Default.Scripts.BehaviourTree.Runtime.Actions;
using Default.Scripts.BehaviourTree.Runtime.Composites;
using UnityEditor;
using UnityEditor.Experimental.GraphView;
using UnityEditor.UIElements;
using UnityEngine;
using UnityEngine.UIElements;
using Node = Default.Scripts.BehaviourTree.Runtime.Node;
    ...
    public class NodeView : UnityEditor.Experimental.GraphView.Node {
        ...
        void SetSubTreeLabel(Label label, SerializedProperty property) {
            if (property.objectReferenceValue == null) {
                ...
                Runtime.BehaviourTree treeAsset = property.objectReferenceValue as Runtime.BehaviourTree;
