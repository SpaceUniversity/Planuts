...
namespace Default.Scripts.BehaviourTree {
    ...
    public class BehaviourTreeEditorWindow : EditorWindow {
        ...
        public Runtime.BehaviourTree CurrentTree {
            get {
                var activeTab = tabView.activeTab as TreeViewTab;
                if (activeTab != null) {
        ...
        public void NewTab(Runtime.BehaviourTree newTree, bool focus, string tabName) {
        ...
        void OnToolbarNewAsset() {
            Runtime.BehaviourTree tree = EditorUtility.CreateNewTree();
            if (tree) {
                NewTab(tree, true, tree.name);
            }
        }
