        ...
        public void SetOriginalText(string newText)
        {
            ...
            foreach (Match match in matches)
            {
                ...
                if (realMatch.Success)
                {
                    ...
                    PrintStyle style = GlobalPrinterSetting.GetInstance().FindDialogStyle(sytleName);
                    ...
                    {
                        _dialogStyle.Add(GlobalPrinterSetting.GetInstance().defaultTextAnimationStyle);
                    }
                }
                else
                {
